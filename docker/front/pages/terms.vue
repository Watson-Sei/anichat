<template>
  <div class="main">
    <h1>AniChatサービス利用規約</h1>
    <p class="update-date">最終更新日: 2021年3月8日</p>
    <p>この利用規約（以下，「本規約」といいます。）は，AniChat（以下，「当社」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。</p>
    <h2>第1条（適用）</h2>
    <ol>
    ...
    <h2>第12条（個人情報の取扱い）</h2>
    <p>当社は，本サービスの利用によって取得する個人情報については，当社<nuxt-link to="/policy">「プライバシーポリシー」</nuxt-link>に従い適切に取り扱うものとします。</p>
    <h2>第13条（通知または連絡）</h2>
